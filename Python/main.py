from Algo.affinity import affinity_matrix
from Algo.onegroup import onegroup
from Algo.group_generation import group_generation
from Algo.research_groups import research_groups
